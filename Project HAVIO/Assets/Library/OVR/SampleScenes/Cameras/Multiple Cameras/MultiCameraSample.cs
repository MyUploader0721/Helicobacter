...
public class MultiCameraSample : MonoBehaviour {
	...
	void Update() {
        ...
        if ( OVRInput.GetDown(OVRInput.RawButton.RShoulder) ||
            OVRInput.GetDown(OVRInput.RawButton.RIndexTrigger, OVRInput.Controller.Gamepad) ||
            ...
            OVRInput.GetDown(OVRInput.RawButton.LIndexTrigger, OVRInput.Controller.Gamepad) ) {
            //*************************
